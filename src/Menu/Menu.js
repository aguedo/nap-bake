    ...
    <div>
      ...
      <div className="grid-flow-row auto-rows-max mt-6 mb-8 justify-center">
        <input
          ...
          placeholder="Search"
          className="w-64 border-2 border-gray-300 p-2 rounded-lg mt-2 mr-4"
        />
        <select
          className="w-48 border-2 border-gray-300 p-2 rounded-lg mt-2"
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 xs:grid-cols-1 justify-center gap-4">
    ...
    <div className="max-w-sm rounded overflow-hidden shadow-lg bg-gray-100">
      ...
      <div className="px-6 py-4">
        <div className="font-bold text-xl mb-2 text-blue-600">
          <Link to={details.link}>{details.name}</Link>
        </div>
